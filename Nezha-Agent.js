/*
Acknowledgement
This project is based on https://github.com/xream/scripts/blob/main/surge/modules/nezha-agent/nezha-agent.js#L229 by https://github.com/xream/scripts. Thanks to @xream for the fantastic work.
*/
...
const PLATFORM_VERSION = arg?.PLATFORM_VERSION ?? '未知平台版本'
...
!(async () => {
  if (isResponse()) {
    ...
    if (body?.result?.[0]?.host) {
      ...
      console.log(device.host.Version)
    }
    // else {
